    ...
    <div className="box projects_middle_child_container">
      ...
      <div className="box projects_middle_child_1">
        ...
        <div className="box projects_middle_child_1_right">
          ...
          <div className="box projects_middle_child_desc">
            <p className="projects_desc">A website that allows users to look up any vehicle by its year, make, model, and trim and get maintenance information,<br/>
            like engine type, oil change interval, dashboard lights meaning, user manual, and more. 🛠️ 🚗<br/>
            You can visit the final project by clicking on the image. &#128072;<br/>
            &#8226; Used ReactJS, CSS, Flexbox to create the front-end of the website, to make it appealing for the user and <br/>
            accessible from any devices including desktop all the way down to mobile sizes. &#128241; &#128187;<br/>
            ...
            speed up the search and responses</p>
          </div>
        </div>
      </div>
      <div className="box projects_middle_child_2">   
        <div className="box projects_middle_child_2_left">
          ...
          <div className="box projects_middle_child_desc">
            <p className="projects_desc">A simple website that allows users to Create, Read, Update, and Delete any tasks. &#128221;<br/>
            You can visit the final project by clicking on the image. &#128073;<br/>
            &#8226; A website created using ReactJS, CSS, MondoDB and Golang. 🗄️<br/>
            &#8226; The website uses Goang as the Back-end to perform the tasks faster. &#9889;<br/>
            &#8226; Created a MondoDB shema to Store &#128229;, Read &#128228;, and Write all the tasks using json formating.</p>
          </div>
        </div>
        <div className="box projects_middle_child_2_right">
      ...
      <div className="box projects_middle_child_1">
        ...
        <div className="box projects_middle_child_1_right">
          ...
          <div className="box projects_middle_child_desc">
            <p className="projects_desc">A simple website that allows users to look up any vehicle from the Database by selecting an ID and<br/>
            Create 🆕, Update 🔄, or Delete 🗑️ the entry selected. 🚗<br/>
            You can visit the final project by clicking on the image. &#128072;<br/>
            &#8226; Created only using PHP files while adding some CSS for styling and MySQL as database.<br/>
            &#8226; Stored all the data in a MySQL Database to perfom the CRUD operations. 🗄️</p>
          </div>
        </div>
      </div>
